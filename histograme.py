...
plt.xlabel('Survived')
plt.ylabel('Frecventay')
plt.xticks([0, 1])
plt.grid(True)
plt.savefig("./cerinta3/Survived.png")
...
plt.xticks([1, 2, 3])
plt.grid(True)
plt.savefig("./cerinta3/PClass.png")
...
plt.ylabel('Frecventa')
plt.grid(True)
plt.savefig("./cerinta3/SibSp.png")
...
plt.ylabel('Frecventa')
plt.grid(True)
plt.savefig("./cerinta3/Parch.png")
plt.close()
